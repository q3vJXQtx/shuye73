...
[task_local]
#签到领现金
2 0 * * * https://raw.githubusercontent.com/shuye73/MyActions/main/scripts/jd_cash.js, tag=签到领现金, enabled=true

================Loon==============
[Script]
cron "2 0 * * *" script-path=https://raw.githubusercontent.com/shuye73/MyActions/main/scripts/jd_cash.js,tag=签到领现金

===============Surge=================
签到领现金 = type=cron,cronexp="2 0 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/shuye73/MyActions/main/scripts/jd_cash.js

============小火箭=========
签到领现金 = type=cron,script-path=https://raw.githubusercontent.com/shuye73/MyActions/main/scripts/jd_cash.js, cronexpr="2 0 * * *", timeout=200, enable=true
 */
const $ = new Env('签到领现金');
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({url: `https://raw.githubusercontent.com/shuye73/RandomShareCode/master/JD_Cash.json`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
