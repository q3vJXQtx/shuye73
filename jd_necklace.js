...
[task_local]
#点点券
10 0,20 * * * https://raw.githubusercontent.com/shuye73/MyActions/main/scripts/jd_necklace.js, tag=点点券, enabled=true

================Loon==============
[Script]
cron "10 0,20 * * *" script-path=https://raw.githubusercontent.com/shuye73/MyActions/main/scripts/jd_necklace.js,tag=点点券

===============Surge=================
点点券 = type=cron,cronexp="10 0,20 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/shuye73/MyActions/main/scripts/jd_necklace.js

============小火箭=========
点点券 = type=cron,script-path=https://raw.githubusercontent.com/shuye73/MyActions/main/scripts/jd_necklace.js, cronexpr="10 0,20 * * *", timeout=200, enable=true
 */
const $ = new Env('点点券');
